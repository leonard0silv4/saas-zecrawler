...
const SLIDES = [
  ...
  },
  {
    ...
    body: "Com os links cadastrados, o sistema agrupa os produtos pelo mesmo SKU e coloca todos os sellers frente a frente. Você vê quem está com o preço mais baixo e recebe alertas automáticos quando sua loja estiver mais de 10% acima do melhor concorrente.",
    icon: LineChart,
    color: "bg-sky-500",
    tip: "Configure Meus Sellers em Configurações para que o sistema saiba quais preços são seus. Sem isso, toda loja aparece como concorrente.",
  },
  {
    id: "seller-monitor",
